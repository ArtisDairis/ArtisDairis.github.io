...
<div class="Svetkijums">
	...
	<div class="content">
		...
		<div class="tabula">
			<div class="tabl">
				<a href="organizatoriadd.php"><input type="button" value="Pievienot" class="butl"></a>
				<a href=""><input type="button" value="Redigēt" class="butl"></a>
			...
			<div class="tabr">
				<?php
					include "PHP/Tables/organizatorsp.php";
				?>
			</div>			
		</div>
	</div>
